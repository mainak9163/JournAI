...
export default function Landing() {
  ...
  Unlock a rich journaling experience with features like a <b>powerful editor</b>, <b>AI-powered chats</b> with your entries, and <b>sentiment analysis</b> for insightful scores. 
</p>

<RainbowButton onClick={()=>{redirect("/login")}}>Get Started</RainbowButton>
      </div>      
    </div>
  )
}